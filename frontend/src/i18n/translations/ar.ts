export const ar = {
  ...
  projects: {
    ...
    images: [
      ...
      { label: "أعمال حفر وسند الجوانب", category: "سند حفريات" },
      ...
      { label: "تدعيم الجوانب والرقابة الميدانية", category: "سند حفريات" },
      { label: "معدات الحفر الثقيلة", category: "سند حفريات" },
      { label: "أعمال التدعيم وسند الجوانب الخشبي", category: "سند حفريات" },
      { label: "أعمال تسليح وتثبيت السند", category: "سند حفريات" },
      { label: "تنفيذ ميداني متقدم", category: "شوتكريت" },
      { label: "أعمال رش الخرسانة (شوتكريت)", category: "شوتكريت" },
