...
export function FinalCTASection() {
  ...
  const InteractiveChevron = isRTL ? ChevronLeft : ChevronRight;
  const statIcons = [Building2, MapPin];
          ...
          <div className="text-start">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-equipment-orange/10 px-4 py-2 rounded-full border border-equipment-orange/20 mb-8 backdrop-blur-sm">
                ...
                <span className="text-equipment-orange font-bold text-sm tracking-wide">{t.contact.badge}</span>
              </div>
                  ...
                  return (
                    ...
                    >
                      <div className="w-12 h-12 rounded-full bg-equipment-orange/10 flex items-center justify-center shrink-0 border border-equipment-orange/20">
                        <Icon className="w-6 h-6 text-equipment-orange" />
                      </div>
                      <div>
            ...
            <div className="relative bg-[#111111]/80 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-8 md:p-10 overflow-hidden group shadow-2xl">
              ...
              <div className="relative z-10 space-y-6">
                <div className="text-center mb-10">
                  <h3 className="text-2xl font-bold text-white mb-3">{t.contact.contactExperts}</h3>
                  <p className="text-white/50 text-sm">{t.contact.contactSubtitle}</p>
                </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div className="text-start">
                      <div className="text-white font-bold text-lg">{t.contact.whatsapp}</div>
                      <div className="text-white/90 text-sm">{t.contact.whatsappSub}</div>
                    </div>
                  </div>
                  <InteractiveChevron className="w-6 h-6 text-white/70 relative z-10" />
                </motion.a>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-start">
                      <div className="text-white font-bold text-lg">{t.contact.email}</div>
                      <div className="text-white/50 text-sm" dir="ltr">{contactInfo.email}</div>
                    </div>
                  </div>
                  <InteractiveChevron className="w-6 h-6 text-white/30 group-hover/mail:text-white/70 transition-colors" />
                </motion.a>
